...
public class AddSuratIzinRepsitory {
    private ApiInterface apiInterface;

    public  AddSuratIzinRepsitory(){
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
    }

    public MutableLiveData<MessageOnly> addSuratIzin(MultipartBody.Part image, RequestBody alasan,RequestBody id_users){
        final MutableLiveData<MessageOnly> mutableLiveData = new MutableLiveData<>();
        Call<MessageOnly> requestOrder = apiInterface.addSuratIzin(image,alasan,id_users);
